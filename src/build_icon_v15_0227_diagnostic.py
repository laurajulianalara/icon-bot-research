...
new = """                            bool v15 = score >= V15_SCORE_THRESHOLD
                            ...
                            if diag0227
                                ...
                                array.set(diag0227Vals, 9, p0)
                                array.set(diag0227Vals, 10, p1)
                                array.set(diag0227Vals, 11, p2)
                                array.set(diag0227Vals, 12, p3)
                                array.set(diag0227Vals, 13, p4)
                                array.set(diag0227Vals, 14, p5)
                                array.set(diag0227Vals, 15, p6)
                                array.set(diag0227Vals, 16, p7)
                                array.set(diag0227Vals, 17, p8)
